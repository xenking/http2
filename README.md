...
```bash
go get github.com/xenking/http2@v0.3.5
```
...
Then, you can call [ConfigureServer](https://pkg.go.dev/github.com/xenking/http2#ConfigureServer).
...
Benchmark code [here](https://github.com/xenking/http2/tree/master/benchmark).
